...
public class ManejadorUsuarios {
	...
	private Map<String, Usuario> coleccionUsuarios = new TreeMap<>();
	...
	/**
	 * Devuelve una lista de DTUsuario con la informacion de todos los usuarios registrados en el sistema.
	 */
	List<DTUsuario> obtenerListaUsuarios() {
		...
		return coleccionUsuarios.entrySet()
		.stream()
		.map(entry -> entry.getValue().toDataType())
