...
/**
 * Servlet implementation class ModificarContraseña
 */
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	if(jwt!= null) {
    		 ...
    		 DtUsuario user = portUsuarios.obtenerDatosDeUsuarioJWT(jwt);
 	         ...
 	         switch(tipoUsuario) {
 	         	case "empresa":
 	         		request.getRequestDispatcher("/WEB-INF/empresa/modificarContraseña.jsp").forward(request, response);
 	         		break;
 	         	case "postulante":
 	         		request.getRequestDispatcher("/WEB-INF/postulante/modificarContraseña.jsp").forward(request, response);
 	         		break;
 	         	default:
