...
public class TestControladorUsuario {
	...
	void testListarUsuarios_UnUsuarioPostulante() {
		...
		LocalDate fechaNacimientoTest = LocalDate.now();
	...
	void testAltaPostulante_NicknameRepetido() {
		...
		LocalDate fechaNacimientoTest2 = LocalDate.now();
	...
	void testActualizarDatosPostulante_Ok() {
		...
		String fechaNacimientoCambiado = "15/10/2022";
		String nacionalidadCambiado = "nacionalidadPostulanteDos";
		controladorUsuario.actualizarDatosPostulante(nicknameTest, nombreCambiado, apellidoCambiado, fechaNacimientoCambiado, nacionalidadCambiado);
		
		// checkeo que este bien
		LocalDate fechaNacimientoCambiadoParseado = LocalDate.parse(fechaNacimientoCambiado, DateTimeFormatter.ofPattern("dd/MM/yyyy"));
	...
	void testActualizarDatosEmpresa_Ok() {
		...
		controladorUsuario.actualizarDatosEmpresa(nicknameTest, nombreCambiado, apellidoCambiado, nombreEmpresaCambiado, descripcionCambiado, linkWebCambiado);
